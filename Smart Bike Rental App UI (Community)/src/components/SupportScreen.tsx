...
const faqs = [
  {
    question: 'How do I unlock a bike or scooter?',
    answer: 'You can unlock a vehicle by scanning the QR code on it, tapping with NFC, or entering the vehicle code manually in the app.'
  },
  {
    question: 'What if I have an issue during my ride?',
    answer: 'If you encounter any problems during your ride, use the "Report Issue" button in the app or contact our 24/7 support team immediately.'
  },
  {
    question: 'How is the fare calculated?',
    answer: 'Fares are calculated based on the duration of your ride. There\'s a base unlock fee plus a per-minute charge. You can see the rates in the app before starting your ride.'
  },
  {
    question: 'What should I do if the vehicle is damaged?',
    answer: 'Please report any damage through the app before starting your ride. This helps us maintain our fleet and ensures you won\'t be charged for pre-existing damage.'
  },
  {
    question: 'Can I pause my ride?',
    answer: 'Yes, you can pause your ride by locking the vehicle. The timer will continue but at a reduced rate. When you\'re ready to continue, simply unlock it again.'
  },
];
      ...
      <div className="flex-1 px-6 py-4 overflow-auto pb-6">
        ...
        >
          ...
          <Button
            onClick={handleEmail}
            variant="outline"
            className="h-auto py-4 flex flex-col gap-2 border-2 rounded-2xl"
          >
              ...
              {faqs.map((faq, index) => (
                <AccordionItem key={index} value={`item-${index}`} className="border-b last:border-b-0">
                  <AccordionTrigger className="px-4 py-4 hover:no-underline hover:bg-gray-50">
                    <span className="text-left text-[#1E1E1E]">{faq.question}</span>
                  </AccordionTrigger>
        ...
        >
          <h3 className="text-[#1E1E1E] mb-4 flex items-center gap-2">
            <Shield className="w-5 h-5 text-[#A6FF00]" />
            Safety & Riding Tips
          </h3>
        ...
        >
          <h3 className="text-[#1E1E1E] mb-4">Quick Links</h3>
          <div className="space-y-2">
            <Card className="p-4 rounded-2xl border-2 flex items-center justify-between hover:shadow-md transition-shadow cursor-pointer">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#007BFF]/10 rounded-xl flex items-center justify-center">
                  <Bike className="w-5 h-5 text-[#007BFF]" />
                </div>
                <span className="text-[#1E1E1E]">How to Ride</span>
              </div>
            ...
            <Card className="p-4 rounded-2xl border-2 flex items-center justify-between hover:shadow-md transition-shadow cursor-pointer">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[#1E1E1E]">Payment & Billing</span>
              </div>
              <ChevronDown className="w-5 h-5 text-gray-400 -rotate-90" />
            </Card>
          </div>
