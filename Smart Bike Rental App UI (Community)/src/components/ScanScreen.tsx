  ...
  return (
    <div className="relative w-full h-full bg-black flex flex-col">
      ...
      <div className="relative z-10 px-6 py-4 flex items-center justify-between">
        ...
        <h2 className="text-white">Unlock Vehicle</h2>
        <div className="w-10" />
      </div>
      ...
      <div className="flex-1 relative flex items-center justify-center">
        ...
        {!unlocked ? (
            ...
            <div className="relative w-64 h-64">
              ...
              {isScanning && (
                <motion.div
                  ...
                  className="absolute left-0 right-0 h-1 bg-[#A6FF00] shadow-lg shadow-[#A6FF00]/50"
                />
              )}
            </div>
          ...
          >
            ...
            <p className="text-white text-xl">Unlocked!</p>
            <p className="text-white/70 mt-2">Starting your ride...</p>
          </motion.div>
        )}
      </div>
          ...
          {!showManualEntry ? (
            <>
              ...
              <Button
                ...
                disabled={isScanning}
                variant="outline"
                className="w-full border-2 border-[#A6FF00] text-[#1E1E1E] hover:bg-[#A6FF00]/10 rounded-2xl h-14"
              >
            ...
            <Card className="p-4 rounded-2xl border-2 space-y-4">
              <div className="space-y-2">
                <label className="text-[#1E1E1E]">Vehicle Code</label>
                <Input
